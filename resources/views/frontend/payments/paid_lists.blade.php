...
@section('content')
<div class="container paid-list py-4">

    <div class="row mb-3">
        <div class="col-6">
            <button class="btn btn-danger" id="move_unpaid">Move to Unpaid Lists</button>
        </div>
    ...
    <div class="row">
        <div class="col-12">
            <table class="table table-striped paid-list-tbl">
                <thead>
                ...
                <tbody>
                    ...
                    @else
                    <tr>
                        <td colspan="2" align="center"> Empty Paid List!</td>
                    </tr>
                    @endif
                </tbody>
            </table>
        ...
        $("#move_unpaid").click(function() {
			...
			{  
				...
				if(check == true){  
					...
					$.ajax({
						url: "{{url('/courses/do-unpaid-students/'.$data['course_id'])}}",
						type: 'get',
