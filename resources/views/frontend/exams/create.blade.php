    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" name="exam_name" id="exam_name" class="form-control" autocomplete="off" required placeholder="Exam Name">
            </div>
            <div class="form-group">
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="shuffle_question_yes" style="margin-right: 20px">
                                    <input type="radio" name="shuffle_question" id="shuffle_question_yes" value="1" required> Yes
                                </label>
                                <label for="shuffle_question_no">
                                    <input type="radio" name="shuffle_question" id="shuffle_question_no" value="0"> No
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group">
                                <label for="shuffle_answer_yes" style="margin-right: 20px">
                                    <input type="radio" name="shuffle_answer" id="shuffle_answer_yes" value="1" required> Yes
                                </label>
                                <label for="shuffle_answer_no">
                                    <input type="radio" name="shuffle_answer" id="shuffle_answer_no" value="0"> No
                                </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('attempts_allow', $attempts_allow, 1, ['class'=>'form-control','id'=>'attempts_allow', 'required'=>true]) !!}
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        <label for="grading_id">Grading</label>
                        {{-- {!! Form::select('grading_id', $gradings, null, ['class'=>'form-control','id'=>'grading_id', 'placeholder'=>'Select Grading']) !!} --}}
                        <select name="grading_id" id="grading_id" class="form-control" required>
                            <option value="">Select Grading</option>
                            @foreach($gradings as $grading)
                                <option value="{{$grading->ref_no}}"> {{$grading->awarding_body}} </option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="form-group">
                        ...
                        {!! Form::select('question_per_page', $questions_per_page, null, ['class'=>'form-control','id'=>'question_per_page', 'placeholder'=>'Select Question Per Page','required'=>true]) !!}
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
                    <div class="input-group">
                        <div class="form-group mr-2">
                            ...
                            <input type="number" name="exam_duration" id="exam_duration" class="form-control" min="0" placeholder="Exam Duration" required>
                        </div>
                        <div class="form-group">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="start_date" autocomplete="off" placeholder="Start Date Time" id="start_date" class="form-control psmdatetimepicker1">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="end_date" readonly placeholder="End Date Time" id="end_date" class="form-control end_date_time">
                    </div>
                    </div>
                </div>
            </div>
