...
<section class="content">
  ...
  <div class="card">
      ...
      <div class="card-body" >
        {!! Form::open(array('route' => 'slideshows.store','method'=>'POST','enctype'=>'multipart/form-data', 'files'=>true)) !!}

        <div class="row">
          <div class="col-md-6 col-sm-6 col-12">
            <div class="form-group">
              <label for="slide_name">Slide Name *</label>
              {!! Form::text('slide_name', null, ['class'=>'form-control','id'=>'slide_name', 'placeholder'=>'Enter Slide Name', 'required'=>true, 'autocomplate'=>'off']) !!}
            </div>    
          </div>
        </div>
          ...
          <div class="col-md-6 col-sm-6 col-12">
              ...
              <div class="form-group">
                  <div class="input-group">
                     ...
                     <input id="slide_photo" class="form-control" type="text" name="slide_photo" required>
                  </div>
               </div>
          </div>
        </div>
