...
<section class="content">
  ...
  <div class="card">
      <div class="card-body py-5">
        ...
        <input type="hidden" name="certificate_type" id="certificate_type" value="portrait">
        ...
        <div class="preview-wrapper mt-5">
            ...
            <div class="sample-certificate">
                ...
                {{-- <a href="{{asset('assets/images/portrait-preview.jpg')}}" data-toggle="lightbox" data-title="Certificate Portrait">
                  <img src="{{asset('assets/images/portrait-preview.jpg')}}" alt="Certificate Portrait">
                </a> --}}
