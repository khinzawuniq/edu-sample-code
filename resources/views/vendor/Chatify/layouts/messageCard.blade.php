...
@if($viewType == 'default')
    ...
    <div>
        <div class="message-card">
            ...
            <div class="image-file chat-image" style="width: 100px; height: 60px;background: url('{{ asset('storage/'.config('chatify.attachments.folder').'/'.$attachment[0]) }}') no-repeat top;background-size:contain;">
            </div>
        </div>
    </div>
    @endif
